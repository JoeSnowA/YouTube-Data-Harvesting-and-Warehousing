...
st.set_page_config(page_title="Youtube Data Harvesting & Warehousing", page_icon="▶️", layout="wide", initial_sidebar_state="auto", menu_items=None)
st.title(":red[YOUTUBE DATA] :red[HARVESTING] and :red[WAREHOUSING] ▶️ ")

#uploads
api_key = 'AIzaSyAd8Kc09Vnzkpdj355v_6j71OG6w_tL5aI' #from user
youtube = build('youtube','v3',developerKey= api_key)

st.subheader(":blue[Datas Uploading to MongoDB Database] 🔜")
